        ...
        <div style="display: flex; width: 100%; height: 100%; overflow: hidden; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.2), 0 4px 6px -1px rgba(0,0,0,0.1); border: 2px solid #22c55e; border-radius: 0.5rem;">
            ...
            <div id="leftLegendContainer" class="legend-panel" style="flex: 0 0 20%; display: flex; flex-direction: column; overflow: hidden; background: linear-gradient(180deg, #ffffff 0%, #f0fdf4 100%);">
                ...
                <div class="px-3 py-3 touch-scroll show-scrollbar-on-hover" style="flex: 1 1 0; min-height: 0; overflow-y: auto; font-size: 0.85rem;">
                    ...
                    <div class="legend-item-enhanced touch-feedback" onclick="navigateTo('Halal_Building')"><span class="legend-item-dot"></span>Halal Building</div>
                    <div class="legend-item-enhanced touch-feedback" onclick="navigateTo('AREC_Bldg')"><span class="legend-item-dot"></span>AREC Building</div>
                    ...
                    <div class="legend-item-enhanced touch-feedback" onclick="navigateTo('Underconstruction1')"><span class="legend-item-dot" style="background:#e65100;"></span>Construction Site 1</div>
                    <div class="legend-item-enhanced touch-feedback" onclick="navigateTo('Underconstruction2')"><span class="legend-item-dot" style="background:#e65100;"></span>Construction Site 2</div>
            ...
            <div class="map-wrapper map-3d-container" id="mapContainer" style="flex: 1 1 60%; height: 100%; position: relative; overflow: visible; background: linear-gradient(180deg, #e8f5e9 0%, #c8e6c9 100%);">
                ...
                <g>
                    ...
                    <!-- NEW BUILDINGS -->
                    <rect id="AREC_Bldg" width="15.965" height="13.971" x="14.04" y="210.123" ry="0" style="fill:#53ac53;fill-opacity:1;fill-rule:evenodd;stroke:#0b6516;stroke-width:1.5;stroke-dasharray:none;stroke-opacity:1;cursor:pointer;"/>
                    <rect id="Halal_Building" width="54.857" height="9" x="232.682" y="209" ry=".482" style="fill:#53ac53;fill-opacity:1;fill-rule:evenodd;stroke:#0b6616;stroke-width:1;stroke-dasharray:none;stroke-opacity:1;cursor:pointer;"/>
                    <rect id="Food_Center_1" width="6" height="17" x="218.376" y="177" ry="0" style="fill:#53ac53;fill-opacity:1;fill-rule:evenodd;stroke:#0b6113;stroke-width:1;stroke-dasharray:none;stroke-opacity:1;cursor:pointer;"/>
                    <rect id="Food_Center_2" width="6" height="17" x="288" y="177" ry="0" style="fill:#53ac53;fill-opacity:1;fill-rule:evenodd;stroke:#0b6113;stroke-width:1;stroke-dasharray:none;stroke-opacity:1;cursor:pointer;"/>
                    <rect id="Underconstruction1" width="11.996" height="21.702" x="13.04" y="98" rx="0" ry="0" style="fill:#f5a623;fill-opacity:0.8;fill-rule:evenodd;stroke:#e65100;stroke-width:1;stroke-dasharray:none;stroke-opacity:1;cursor:pointer;"/>
                    <rect id="Underconstruction2" width="11.996" height="21.702" x="13.04" y="122" rx="0" ry="0" style="fill:#f5a623;fill-opacity:0.8;fill-rule:evenodd;stroke:#e65100;stroke-width:1;stroke-dasharray:none;stroke-opacity:1;cursor:pointer;"/>
                </g>
                <g id="BuildingLabels">
                    <!-- ========================================
                    ...
                    <!-- === NEW BUILDINGS LABELS === -->
                    
                    <!-- AREC Building -->
                    <rect x="6" y="212" width="28" height="6" rx="1.5" fill="white" fill-opacity="0.95" stroke="#248823" stroke-width="0.4" style="pointer-events:none;filter:drop-shadow(0 1px 3px rgba(0,0,0,0.12));"/>
                    <text x="20" y="216.5" text-anchor="middle" font-size="2.8" font-weight="600" fill="#1a5c1a" style="pointer-events:none;">AREC Bldg</text>
                    
                    <!-- Halal Building -->
                    <rect x="235" y="204" width="50" height="6" rx="1.5" fill="white" fill-opacity="0.95" stroke="#248823" stroke-width="0.4" style="pointer-events:none;filter:drop-shadow(0 1px 3px rgba(0,0,0,0.12));"/>
                    <text x="260" y="208.5" text-anchor="middle" font-size="3" font-weight="600" fill="#1a5c1a" style="pointer-events:none;">Halal Building</text>
                    
                    <!-- Under Construction 1 -->
                    <rect x="4" y="100" width="26" height="5" rx="1" fill="#fff3e0" fill-opacity="0.95" stroke="#e65100" stroke-width="0.3" style="pointer-events:none;filter:drop-shadow(0 1px 2px rgba(0,0,0,0.1));"/>
                    <text x="17" y="104" text-anchor="middle" font-size="2" font-weight="600" fill="#e65100" style="pointer-events:none;">Under Const. 1</text>
                    
                    <!-- Under Construction 2 -->
                    <rect x="4" y="123" width="26" height="5" rx="1" fill="#fff3e0" fill-opacity="0.95" stroke="#e65100" stroke-width="0.3" style="pointer-events:none;filter:drop-shadow(0 1px 2px rgba(0,0,0,0.1));"/>
                    <text x="17" y="127" text-anchor="middle" font-size="2" font-weight="600" fill="#e65100" style="pointer-events:none;">Under Const. 2</text>
                </g>
...
<script>
    ...
    let navigationPoints = {
        ...
        'AREC Bldg': {x: 22, y: 217, roadConnection: 'south_30'},
        'Halal_Building': {x: 260, y: 202, roadConnection: 'spine_south'},
        'Halal Building': {x: 260, y: 202, roadConnection: 'spine_south'},
        'Food_Center_1': {x: 221, y: 186, roadConnection: 'spine_185'},
        'Food_Center_2': {x: 265, y: 185, roadConnection: 'spine_185'},
        'Underconstruction1': {x: 19, y: 109, roadConnection: 'far_west_80'},
        'Underconstruction2': {x: 19, y: 133, roadConnection: 'horiz_30'},
    ...
    const buildingCategories = {
        ...
        'AREC_Bldg': 'Research & Innovation',
        'Halal_Building': 'Facilities & Services',
        'Food_Center_1': 'Facilities & Services',
        'Food_Center_2': 'Facilities & Services',
        'Underconstruction1': 'Under Construction',
        'Underconstruction2': 'Under Construction'
    };
    ...
    const svgToDisplayName = {
        ...
        'AREC_Bldg': 'AREC Building',
        'Halal_Building': 'Halal Building',
        'Food_Center_1': 'Food Center 1',
        'Food_Center_2': 'Food Center 2',
        'Underconstruction1': 'Under Construction Area 1',
        'Underconstruction2': 'Under Construction Area 2'
    };
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const clickableBuildings = ['Administration', 'CTE', 'CHS', 'CCJE', 'BCSF', 'UPP', 'AMTC', 'ULRC', 'TCL', 'DOST', 
                                   ...
                                   'AREC_Bldg', 'Halal_Building', 'Food_Center_1', 'Food_Center_2', 'Underconstruction1', 'Underconstruction2'];
